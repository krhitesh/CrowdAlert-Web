...
const FormTab = (props) => {
  if (props.reportForm.isFreezed && !props.reportForm.loading) {
    return (<Redirect to={`/edit/${props.eventid}/images`} data-test="redirect-images" />);
  }
  return (
        ...
        <Grid.Row>
          <Grid.Column>
            <Form loading={props.reportForm.loading}>
              <Form.Field>
                ...
                <Header as="h4">
                  ...
                  <Header.Content>
                    ...
                    <Header.Subheader>
                      <Link to={`/edit/${props.eventid}/location`} data-test="link-change">Change</Link>
                    </Header.Subheader>
                  </Header.Content>
                </Header>
              </Form.Field>
              ...
              >
                <Icon name="check" /> Update Incident
              </Form.Button>
            </Form>
          </Grid.Column>
        </Grid.Row>
...
const mapDisptachToProps = dispatch => (
  bindActionCreators({
    handleInputChange: updateEventDetailsEditEvents,
    handleSubmit: validateFormEditEvents,
    handleTabChange: changeTabEditEventsForm,
  }, dispatch)
);
